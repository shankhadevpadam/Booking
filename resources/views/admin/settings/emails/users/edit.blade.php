...
<div class="row">
	<div class="col-sm-12 mb-2">
		<a class="btn btn-primary" href="{{ route('admin.settings.user.email') }}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a>
	</div>
</div>

<form method="post" action="{{ route('admin.settings.user.email.update') }}">
	...
	<div class="row">
		...
		<div class="col-md-4 col-sm-12">
			<x-adminlte-card title="Labels" id="labels">
				...
				<span class="btn btn-sm btn-success mb-1">{flight_number}</span>
				<span class="btn btn-sm btn-success mb-1">{airport_pickup}</span>
				...
				<span class="btn btn-sm btn-success mb-1">{remaining_payment_with_bank_charge}</span>
