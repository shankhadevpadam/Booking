...
<div class="row">
	<div class="col-sm-12 mb-2">
		<a class="btn btn-primary" href="{{ route('admin.settings.cron.email') }}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a>
	</div>
</div>

<form method="post" action="{{ route('admin.settings.cron.email.update') }}">
