...
<div class="branding">
	<h1 aria-label="NicAsia Bank Limited">
		Payment of {{ ( $currencyCode == 'USD' ) ? '$' : 'Rs.' }}{{ number_format($amount) }}
		<br><br>
...
<form action="{{ $transactionUrl }}" method="post" id="nicAsia-form">
...
@section('javascript')
	<script>
		...
		window.onload = function() {
			nicAsia_submit = setTimeout(nicAsiaApp.init, {{ $redirectWait }})
		}
	</script>
@endsection